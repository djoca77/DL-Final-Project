...
def get_default_CNN_model(
    ...
    model = CustomSequential(
            [
             Conv2D_manual(42,(3,3),strides=(2, 2),activation='leaky_relu'),
             BatchNormalization(),
             Conv2D(25,(3,3),strides=(2, 2),activation='leaky_relu'),
             BatchNormalization(),
             Conv2D(16,(2,2),strides=(2, 2),activation='leaky_relu'),
             BatchNormalization(),
             Dropout(0.04),
             tf.keras.layers.Flatten(),

             tf.keras.layers.Dense(84, activation='leaky_relu'),
